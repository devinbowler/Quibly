...
const AuthHome = () => {
  ...
  const renderDynamicText = () => {
    if (windowWidth <= 1350) {
      return <span className="type-animation">Quibly</span>;
    } else {
      return (
        <>
  ...
  return (
    <div className="home-page" id="home">
      ...
      <span className="quantumix-nav-title">
        <img src={QuantumixLogo} alt="Quibly Logo" />
      </span>
      ...
      <div className="landing-container">
        <div className="content-section">
          ...
          <p className="main-description">Quibly is an all-in-one productivity app <br /> designed to streamline the management of <br />schedules, tasks, projects, and more.</p>
        ...
        <div className="cs-container">
            <h2 className="cs-title"><span className="blueFirst">WHAT</span> IS QUIBLY</h2>
            <p className="cs-text">
            Quibly is an all-in-one management app designed to streamline organization 
            ...
            Quibly offers a holistic solution for both personal and professional organization needs.
            </p>
            ...
            <p className="cs-item-text">Quibly offers flexible storage plans, allowing you to pay only for the space you need. Begin with a generous amount of free storage, and upgrade seamlessly as your organizational needs grow, ensuring optimal cost efficiency and scalability.</p>
        </li>
        <li className="cs-item">
            <div className="cs-box" aria-hidden="true">
            ...
            <p className="cs-item-text">Experience the simplicity of Quibly's user interface, designed for intuitive navigation and ease of use. Our app streamlines task management and planning, allowing you to focus on productivity without the complexity of unnecessary features.</p>
        </li>
        <li className="cs-item">
            <div className="cs-box" aria-hidden="true">
            ...
            <p className="cs-item-text">Quibly offers cost-effective membership options, ensuring that you get maximum value for minimal expense. Our competitive pricing plans are designed to fit a variety of budgets, making high-quality organization tools accessible to everyone.</p>
        </li>
            </ul>
        </div>
    </section>
    ...
    <section id="pricing">
        <div className="cs-container">
            ...
            <p className="cs-text">
                Welcome to Quibly, your one solution for all your management needs. Browse through our pricing plans, which offer plans too expand your storage and capabilites.
            </p>
